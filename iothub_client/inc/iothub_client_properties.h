...
typedef struct IOTHUB_CLIENT_DESERIALIZED_PROPERTY_TAG {
    /** @brief   Version of the structure.  Currently will be set to IOTHUB_CLIENT_DESERIALIZED_PROPERTY_VERSION_1 by IoTHubClient_Serialize_ReportedProperties. */
    int structVersion;
    ...
    */
    ...
    /** @brief Number of bytes in valueLength.  Does not include terminating \0 if IOTHUB_CLIENT_PROPERTY_VALUE_STRING is set */
    size_t valueLength;
